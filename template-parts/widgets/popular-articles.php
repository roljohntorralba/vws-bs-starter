<section id="widget-popular-articles" class="widget mb-4">
    ...
    if($popular_posts->have_posts()): ?>
        <div class="list-group">
            <?php while ($popular_posts->have_posts()) : $popular_posts->the_post(); ?>
                <a href="<?php the_permalink() ?>" class="list-group-item list-group-item-action d-flex justify-content-between align-items-baseline">
                    <div>
  ...
  <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zM4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0z"/>
                        ...
                        <?php vws_get_page_views(null, null); ?>
                    </span>
                </a>
